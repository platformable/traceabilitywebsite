  ...
  const clientToken = user?.APIToken
    ...
    return (
      <main
        ...
        className="relative pt-20 min-h-screen shadow-inner bg-[#F2F0FF]"
      >
        <section 
        // id="header-user-survey"
         className="max-w-[600px] mb-20 mx-auto border border-[var(--border-container-forms)] bg-white shadow-lg rounded-xl px-12 mb-10 py-7">
