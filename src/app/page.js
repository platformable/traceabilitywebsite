  ...
  return (
    <main id="home-content" className="bg-primary-gradient min-h-screen max-h-screen overflow-hidden  py-20">
      ...
      <section className=" bg-white p-14 flex flex-col gap-7 lg:w-[35%] items-center lg:items-start">
        <div>
            <img src="/open_health_dashboard_logo_home.svg" alt="health dashboard logo" />
        </div>
        <div id="hero-description" className="">
          <div className="text-[var(--home-highlight)] text-[46px] leading-snug">
        ...
        <button className="bg-[var(--home-highlight)] px-7 text-white font-medium rounded-md shadow py-2">Login / Register</button>
        </Link>
        
      </section>
      <div id="hero-home-img" className="hidden lg:block lg:w-[65%] p-10 hero-home-img">
        <img src="/welcome-page.png" alt="Open Health dashboard features image" className="object-fill"/>
