...
export default function Hero() {
  ...
  return (
    <section className='pt-10 container mx-auto text-center text-[#3423C5]'>
      <h1 className='font-bold text-lg mb-4'>Open Digital Ecosystems</h1>
      <h2 className='font-bold text-4xl mb-20'>How Value is generated and distributed amongst stakeholders in a sustainability/traceability data ecosystem</h2>
